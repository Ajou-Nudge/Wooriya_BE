...
public class BoardServiceImpl implements BoardService {
    ...
    @Autowired
    public BoardServiceImpl(CompanyPostDAO companyPostDAO, GroupPostDAO groupPostDAO, MetadataServiceImpl metadataService, PostImageMetaRepository postImageMetaRepository) {
